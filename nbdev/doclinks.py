...
def nbdev_export(
    ...
    **kwargs):
    ...
    cfg = get_config()
    if cfg.get('pyproject_toml'): 
        txt = "# AUTOGENERATED! DO NOT EDIT! File to edit: ./settings.ini.\n\n"
        txt += tomli_w.dumps(cfg2pyproj(cfg), indent=2)
        (cfg.lib_path.parent / "pyproject.toml").write_text()
