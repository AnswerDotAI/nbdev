...
def black_format(
    cell, # Cell to format
    force:bool=False, # Turn black formatting on regardless of pyproject.toml
):
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/export.py#L53"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/export.py#L62"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/export.py#L68"
target="_blank" style="float:right; font-size:smaller">source</a>
