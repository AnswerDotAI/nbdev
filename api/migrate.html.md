...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L89"
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L97"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L126"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L138"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L145"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L158"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L166"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L174"
target="_blank" style="float:right; font-size:smaller">source</a>
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/migrate.py#L272"
target="_blank" style="float:right; font-size:smaller">source</a>
...
version = 1.0.0
''')
    wfd = Path(d)/'.github/workflows'
    wfd.mkdir(parents=True)
    (wfd/'deploy.yaml').write_text('      - uses: fastai/workflows/quarto-ghp@master\n')
    ...
    wf = (Path(d)/'.github/workflows/deploy.yaml').read_text()
    assert 'uses: AnswerDotAI/workflows/quarto-ghp3@master' in wf
```

    Created /var/folders/51/b2_szf2945n072c0vj2cyty40000gn/T/tmp64olumcw/pyproject.toml. You can now delete /var/folders/51/b2_szf2945n072c0vj2cyty40000gn/T/tmp64olumcw/settings.ini and setup.py (if present)
...
dev_requirements = ipython lxml pysym2md monsterui PyJWT
...
test_eq(proj['license'], 'Apache-2.0')  # 'apache2' maps to 'Apache-2.0'
