...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/frontmatter.py#L38"
...
YAML frontmatter can be added to notebooks in one of these ways:

1.  By adding a raw notebook cell with `---` as the first and last
    lines, and YAML between them, or
2.  A markdown cell that is entirely a literal `---` block (same as a
    raw cell), or
3.  A specially formatted markdown cell. The first line should be start
