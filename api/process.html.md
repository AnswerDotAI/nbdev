...
def extract_directives(
    cell, remove:bool=True, lang:str='python'
):
...
def NBProcessor(
    path:NoneType=None, procs:NoneType=None, nb:NoneType=None, debug:bool=False, rm_directives:bool=True, process:bool=False
):
