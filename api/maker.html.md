...
``` python
def import2relative(
    cell:fastcore.nbio.NbCell, libname
):
```
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/maker.py#L198"
target="_blank" style="float:right; font-size:smaller">source</a>
...
# %% ../../01_export.ipynb #b102bbc6
from __future__ import print_function

# %% ../../01_export.ipynb #09e2fb00
#| export
def a(): ...

# %% ../../01_export.ipynb #d5e267cb
#| export
class A:
```
