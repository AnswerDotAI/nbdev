...
The following functions are used to do that. Cleaning also adds cell
`id`s if missing (required by nbformat 4.5+).
...
<a
href="https://github.com/AnswerDotAI/nbdev/blob/main/nbdev/clean.py#L192"
target="_blank" style="float:right; font-size:smaller">source</a>
